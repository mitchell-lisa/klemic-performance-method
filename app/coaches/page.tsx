      ...
      <Section>
        <div className="space-y-16">
          {coaches.map((coach, i) => (
            ...
            >
              <div
                className={`relative aspect-[4/5] max-w-md overflow-hidden border border-ink/40 ${
              ...
              <div>
                ...
                <h2 id={`coach-${i}`} className="display mt-3 text-5xl sm:text-6xl">
                  {coach.name}
                </h2>
      ...
      <Section className="border-t border-ink/30">
        <div className="grid gap-10 lg:grid-cols-2">
          ...
          <div className="self-center border border-ink/30 bg-panel p-8">
            <p className="display text-3xl">Train with the staff</p>

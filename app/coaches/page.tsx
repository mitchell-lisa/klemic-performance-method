    ...
    <>
      <Section className="pb-10 sm:pb-14">
        ...
        <h1 className="serifhead mt-4 max-w-4xl text-6xl sm:text-7xl lg:text-8xl">
          Meet the <span className="text-red">coaches</span>.
        </h1>
      ...
      <Section>
        <div className="space-y-16">
          {coaches.map((coach, i) => (
            ...
            >
              <div
                className={`cropmarks relative aspect-[4/5] max-w-md overflow-hidden border border-ink/40 ${
              ...
              >
                <Image
                  ...
                  className="archival object-cover object-top"
                />
              </div>
              <div>
                <p className="kicker">{coach.title}</p>
                <h2 id={`coach-${i}`} className="serifhead mt-3 text-5xl sm:text-6xl">
                  {coach.name}
                </h2>
      ...
      <Section className="border-t border-ink/30">
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <h2 className="serifhead mt-3 text-4xl sm:text-5xl">One-on-one coaching</h2>
            <ul className="mt-6 space-y-5">
              {privateStaff.map((coach) => (
                <li key={coach.name} className="border-l-2 border-red pl-4">
          ...
          <div className="self-center border border-ink/30 bg-panel p-8">
            <p className="serifhead text-3xl">Train with the staff</p>
